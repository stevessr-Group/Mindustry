...
public class ModsDialog extends BaseDialog{
    ...
    void getModList(Cons<Seq<ModListing>> listener){
        if(modList == null){
            Http.get("https://stevessr-group.github.io/MindustryMods/mods.json", response -> {
                    ...
                    con.add(new BorderImage(){
                        ...
                        public void draw(){
                            ...
                            if(!textureCache.containsKey(repo)){
                                ...
                                Http.get("https://stevessr-group.github.io/MindustryMods/icons/" + repo.replace("/", "_"), res -> {
